...
import { getJournals } from "../services/journalService";
import { SITE_NAME, SITE_TAGLINE } from "../utils/constants";
import heroImage from "../assets/hero-academic-books.png";
  ...
  return (
    <>
      ...
      <section className="relative overflow-visible bg-white">
        <div className="container-custom grid min-h-[520px] items-center gap-8 py-28 lg:grid-cols-2 lg:py-28">
          <motion.div
          ...
          >
            <h1 className="max-w-xl font-heading text-[35px] font-[600] leading-[1.08] text-[#073e40] sm:text-[45px]">
              Where Your
              <br />
              Research Meets
              <br />
            ...
            <p className="mt-6 max-w-md text-base leading-7 text-slate-600">
              Your dedicated partner in academic excellence and professional
              writing.
            </p>

            <div className="mt-7 flex flex-wrap gap-4">
              <Button to="/services"  showArrow className="bg-[#073e40]">
                Explore Services
              </Button>

              <Button to="/submit-paper" variant="outlineDark" showArrow>
                Submit Your Paper
              </Button>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative h-[360px] overflow-hidden rounded-l-[70px] rounded-br-[70px] lg:h-[470px]"
          >
            <img
              src={heroImage}
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#073e40]/20 to-transparent" />

            {/* Floating icons */}
            <motion.div
              animate={{ y: [0, -8, 0] }}
              transition={{ duration: 3, repeat: Infinity }}
              className="absolute right-8 top-12 flex h-14 w-14 items-center justify-center rounded-full border border-[#d2a052]/80 bg-black/20 text-[#d2a052] backdrop-blur-sm"
            >
              <FileText size={25} />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute right-20 top-32 flex h-14 w-14 items-center justify-center rounded-full border border-[#d2a052]/80 bg-black/20 text-[#d2a052] backdrop-blur-sm"
            >
              <Users size={25} />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute bottom-24 right-10 flex h-14 w-14 items-center justify-center rounded-full border border-[#d2a052]/80 bg-black/20 text-[#d2a052] backdrop-blur-sm"
            >
              <Globe2 size={25} />
            </motion.div>
          </motion.div>
        ...
        <motion.div
          ...
          className="container-custom relative z-20 -mt-5 lg:-mt-12"
        >
          <div className="grid grid-cols-2 gap-5 rounded-3xl bg-white p-6 shadow-[0_15px_50px_rgba(5,45,46,0.12)] sm:grid-cols-3 lg:grid-cols-5">
            {STATS.map((stat) => (
